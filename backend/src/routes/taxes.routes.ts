...
import { getTaxes, getTax, createTax, suggestTaxes, suggestTaxWithAI, calculateTaxes, updateTax, deleteTax } from '../controllers/taxes.controller';
...
router.post('/suggest-ai', authenticate, internalAccess, suggestTaxWithAI);
